...
public class FOGIndexTest {
    ...
    @Test
    public void testWithTextInEnglish() throws IOException {
        IndexedDocument indexedDocument = ColemanLiauIndexTest.makeIndexedDocument(TEXT_EN);

        FOGIndex fogIndex = new FOGIndex(indexedDocument);

        assert fogIndex.getFOGIndex() == EXPECTED_FOG_INDEX_EN;
    }

    @Test
    public void testWithTextInFrench() throws IOException {
        IndexedDocument indexedDocument = ColemanLiauIndexTest.makeIndexedDocument(TEXT_FR);
